...
function Footer({ chapter }: { chapter: ChapterData | undefined }) {
  function Chevron({ dir, label }: { dir: "prev" | "next", label: JSX.Element | string }) {
    function Label({ text }: { text: JSX.Element | string }) {
    ...
    return (
      <div className="link-unstyled">
        {chapter && dir in chapter && <Link to={chapter[dir]?.path || ""}>
