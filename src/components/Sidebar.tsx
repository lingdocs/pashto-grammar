...
function Sidebar({ content, navOpen, setNavOpen, pathname }: {
  content: (ChapterData | SectionData)[],
  navOpen: boolean,
  setNavOpen: (v: boolean) => void,
  pathname: string,
}) {
  const openSection = content.find((block): block is SectionData => (
    block.type === "chapter-data"
      ? false
  ...
  function handleHeadingClick(h: string) {
