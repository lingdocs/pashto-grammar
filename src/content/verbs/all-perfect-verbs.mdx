...
The nice thing about perfects is that we can use <Link to="/equatives/other-equatives/#overview-of-8-equatives">any of the 8 equatives</Link>. This gives us a huge amount of expressive power to talk about whether something has happened, had happened, will have happened, might have happened, would have happened, what you wish would have happened etc. etc.
