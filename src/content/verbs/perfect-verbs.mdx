...
Also, you can <Link to="/phrase-structure/shortening-vps/">shorten these VPs</Link> in the same way as you do with other verbs forms, but if you try shortening the examples below you may notice some interesting changes because with the perfect there are <Link to="/verbs/perfect-verbs/#how-to-make-perfect-tenses-">two verb blocks</Link>. 
