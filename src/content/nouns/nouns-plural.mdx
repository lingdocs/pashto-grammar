...
import { pluralNounGame } from "../../games/games";
import GameDisplay from "../../games/GameDisplay";

export const Pattern1 = () => (
  <Link to="/nouns/nouns-unisex/#1-basic">Pattern #1</Link>
);
export const Pattern2 = () => (
  <Link to="/inflection/inflection-patterns/#2-words-ending-in-an-unstressed-%DB%8C---ay">
    Pattern #2
  </Link>
);
